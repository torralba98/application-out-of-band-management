	...
	<body background="/images/background.jpg">
			...
			<?php
				...
				function userAccess($username, $conn) {
					...
					if (!empty($init) && mysqli_num_rows($init) == 0) {
							echo "<p style='margin-left: 2em; color:red'> <br><b>Todavía no has <u>verificado</u> tu cuenta.</b><br></p>";
		...
		function adminAccess($username, $conn) {
			...
			echo "<div id='deviceOff' class='alert alert-success mt-4' role='alert'>
						<FONT SIZE=4><p><a><i><b>TODOS LOS DISPOSITIVOS ACCESIBLES</b> <i></a></p></FONT><br>";
			echo "<div><a id='actualizar' href='inicio' class='btn btn-primary btn-lg active'>Actualizar disp.</a></div>";
			...
			printf ("<form action='' method='post'>");
			if (mysqli_num_rows($result)==0)
				 echo "<p style='margin-left: 2em; color:red'> No hay ningún <u>dispositivo accesible</u>.<br>";
			else {
					include "./web_config/configuration_properties.php";
			...
			echo "<br><br><FONT SIZE=4><p><a><i><b>TODOS LOS DISPOSITIVOS NO ACCESIBLES</b><i></a></p></FONT><br>";
