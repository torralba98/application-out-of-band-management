  ...
  .pageCover {
    ...
    <li><a href="reset-devices">Resetear Dispositivos</a></li>
		...
		<div class='alert alert-success mt-4' role='alert'>
          ...
          ?>
<br>
<p>¿Prefieres resetear un dispositivo en concreto? <a href="http://10.51.1.44/admin/reset-device" data-toggle="collapse" aria-expanded="false" aria-controls="collapse">Click <u>aquí</u>.</a></p>
		</div>
	</body>
